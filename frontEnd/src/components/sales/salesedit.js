...
const SoldBirdEdit = () => {
    ...
    return (
        <MiddleWrapper heading={"Edit Record"}>
                        ...
                        <div className="card-body">
                            <form>
                                <div className="row">
                                    ...
                                    <div className="form-group col-md-6">
                                        <label htmlFor="exampleInputPassword1">Client Phone Number</label>
                                        <input type="password" className="form-control" id="exampleInputPasswor2d1" placeholder="Record Number" />
                                    </div>    
                                    <div className="form-group col-md-6">
                                        <label htmlFor="exampleInputPassword1">Client Details</label>
                                        <input type="password" className="form-control" id="exampleInputPasswor2d1" placeholder="Record Number" />
                                    </div>    
                                </div>
                                    <div className="row">
